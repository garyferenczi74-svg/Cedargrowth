...
export const CANNABINOIDS: Compound[] = [
  cannabinoid(
    ...
    'THC',
    'The primary intoxicating cannabinoid; a partial agonist at CB1.',
  ...
  cannabinoid(
    ...
    'Cannabidiol',
    'CBD',
    'Non-intoxicating; acts across several receptors rather than binding CB1 directly.',
  ...
  cannabinoid(
    ...
    'Cannabigerol',
    'CBG',
    'The biosynthetic parent from which THC, CBD, and CBC are formed.',
    ...
    'Its acid, CBGA, is the parent compound from which THCA, CBDA, and CBCA are synthesized in the plant. As a neutral cannabinoid it binds CB1 and CB2 and interacts with the alpha-2 adrenoceptor, TRPV1, and 5-HT1A.',
    null,
    null,
    ['major', 'non-intoxicating'],
  ),
  cannabinoid(
    ...
    'Cannabichromene',
    'CBC',
    'Non-intoxicating; binds CB2 and the TRP channels rather than CB1.',
    ...
    'Interacts only weakly with CB1 and instead engages CB2 and the transient receptor potential channels TRPV1 and TRPA1.',
    null,
    null,
    ['major', 'non-intoxicating'],
  ),
  cannabinoid(
    ...
    'Cannabinol',
    'CBN',
    'The oxidation product of THC; mildly intoxicating at roughly a tenth of its strength.',
  ...
  cannabinoid(
    ...
    'THCV',
    'The propyl analog of THC; a CB1 antagonist at low amounts and an agonist at high ones.',
    'Molecular weight 286.41 g/mol. A propyl analog with a three-carbon side chain against THC’s five. Typically 0.1 to 2 percent, up to 8 to 15 percent in some African sativa landraces.',
    'CB1 antagonist below about 10 mg and agonist above it. CB2 partial agonist.',
    'Its behavior at CB1 is dose-dependent: at low amounts it opposes activation as an antagonist, and at higher amounts it acts as an agonist. It is a partial agonist at CB2.',
    null,
    null,
    ['major', 'intoxicating'],
  ),
  cannabinoid(
    ...
    'Cannabidiolic acid',
    'CBDA',
    'The raw acid form of CBD, present in unheated plant material.',
    ...
    'The acidic precursor of CBD. It decarboxylates to CBD with heat above about 120C, and over time with light exposure.',
  ...
  cannabinoid(
    ...
    'THCA',
    'The raw acid form of THC; non-intoxicating until it is heated.',
  ...
  cannabinoid(
    ...
    'Cannabidivarin',
    'CBDV',
    'The propyl analog of CBD; active at the TRP channels.',
  ...
  cannabinoid(
    ...
    'THCP',
    'A seven-carbon analog of THC with markedly higher CB1 binding affinity.',
    'A seven-carbon alkyl side chain against THC’s five. Present at well under 0.1 percent.',
    'CB1 binding affinity reported at about 33 times that of THC.',
    'Its longer side chain gives it a CB1 binding affinity reported at roughly 33 times that of THC. Binding affinity is how tightly a molecule attaches to a receptor; it is not the same as potency or effect, and the figure should not be read as either. Identified in 2019.',
    null,
  ...
  cannabinoid(
    ...
    'Cannabidiphorol',
    'CBDP',
    'The seven-carbon analog of CBD, discovered alongside THCP.',
    'A seven-carbon analog of CBD. Present at well under 0.1 percent.',
    null,
    'Discovered at the same time as THCP. Its receptor interactions are not yet fully characterized.',
    null,
    null,
  ...
  cannabinoid(
    ...
    'Cannabielsoin',
    'CBE',
    'A metabolite of CBD found in aged material.',
  ...
  cannabinoid(
    ...
    'Cannabicitran',
    'CBT',
    'Forms from CBC under heat and UV; non-intoxicating.',
    'Present at well under 0.1 percent; more abundant in aged or UV-exposed samples.',
    null,
    'Forms from CBC under heat and ultraviolet light. Its interactions at CB1 and CB2 are not yet clear.',
    'Accumulates in aged or UV-exposed samples, forming from CBC under heat and ultraviolet light.',
    null,
    ['rare', 'non-intoxicating'],
  ),
  cannabinoid(
    ...
    'Cannabicyclol',
    'CBL',
    'A metabolite of CBC, rare in fresh plant material.',
    'Present at well under 0.1 percent; rare in fresh plant material.',
    null,
    'Forms from CBC under acidic conditions. Its receptor profile is not yet characterized.',
    'Rare in fresh material; forms from CBC under acidic conditions over time.',
    null,
    ['rare', 'non-intoxicating'],
  ),
];
...
export const cannabinoidIndex = {
  ...
  headline: 'Fourteen compounds, and what each one actually is.',
  body:
    'Cannabis produces over a hundred and fifty of these. Fourteen appear in ' +
    'meaningful quantity, and each behaves differently at the receptor and ' +
    'differently under heat. What follows is chemistry and mechanism, with ' +
    'sources. Clinical evidence is held for registered practitioners, where it ' +
    'belongs.',
  groups: [
    ...
    { key: 'rare', label: 'RARE', band: 'Less than one tenth of one percent of plant composition' },
  ],
  filters: [
