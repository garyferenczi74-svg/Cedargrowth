...
export const ageGate = {
  ...
  // States the cookie retention in the UI copy, matching the code comment in
  // AgeGate.tsx: the confirmation is a session cookie, not a persistent one.
  retentionNote:
    'Your confirmation is remembered only for this browser session and is cleared when you close your browser.',
  legalCta: 'Legal',
