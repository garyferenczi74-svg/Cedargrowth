...
// Motion (CG Prompt 06, Task 16): the field stays quiet since it is
// disabled. Only its border draws (RuleDraw, replacing the static
// border-b so the line animates instead of appearing static) and the
// caption rises. The label, input, and icon are never wrapped in motion.
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex flex-col gap-2">
        ...
        <RuleDraw className="h-px w-full bg-hairline-inverse" />
      </div>
      <Rise className="text-caption-m md:text-caption text-inverse/70">
